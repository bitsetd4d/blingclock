...
public class AWTUtilitiesWrapper {
    ...
    static void init() {
        try {
            awtUtilitiesClass = Class.forName("com.sun.awt.AWTUtilities"); //$NON-NLS-1$
            translucencyClass = Class.forName("com.sun.awt.AWTUtilities$Translucency"); //$NON-NLS-1$
            ...
            mIsTranslucencySupported = awtUtilitiesClass.getMethod("isTranslucencySupported", translucencyClass); //$NON-NLS-1$
            mIsTranslucencyCapable = awtUtilitiesClass.getMethod("isTranslucencyCapable", GraphicsConfiguration.class); //$NON-NLS-1$
            mSetWindowShape = awtUtilitiesClass.getMethod("setWindowShape", Window.class, Shape.class); //$NON-NLS-1$
            mSetWindowOpacity = awtUtilitiesClass.getMethod("setWindowOpacity", Window.class, float.class); //$NON-NLS-1$
            mSetWindowOpaque = awtUtilitiesClass.getMethod("setWindowOpaque", Window.class, boolean.class); //$NON-NLS-1$
